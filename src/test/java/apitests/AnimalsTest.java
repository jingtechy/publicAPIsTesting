...
public class AnimalsTest {
    ...
    public void catFactsApiTest() {
        ...
        assertThat(catFactList.get(0).getText().equals("Owning a cat can reduce the risk of stroke and heart attack by a third.")).isTrue();
        assertThat(catFactList.get(1).getText().equals("Most cats are lactose intolerant, and milk can cause painful stomach cramps and diarrhea. It's best to forego the milk and just give your cat the standard: clean, cool drinking water.")).isTrue();
        assertThat(catFactList.get(2).getText().equals("Domestic cats spend about 70 percent of the day sleeping and 15 percent of the day grooming.")).isTrue();
        assertThat(catFactList.get(3).getText().equals("The frequency of a domestic cat's purr is the same at which muscles and bones repair themselves.")).isTrue();
        assertThat(catFactList.get(4).getText().equals("Cats are the most popular pet in the United States: There are 88 million pet cats and 74 million dogs.")).isTrue();
    }
